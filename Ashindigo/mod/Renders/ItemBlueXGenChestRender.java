package XGen.Ashindigo.mod.Renders;
...
public class ItemBlueXGenChestRender extends TileEntitySpecialRenderer
{
    ...
    public ItemBlueXGenChestRender()
    {
     ...
     */
    public void renderTileEntityChestAt(BlueXgenChestTileEntity par1TileEntityChest, double par2, double par4, double par6, float par8)
    {
        int i;
        ...
        else
        {
            ...
            if (block instanceof XgenBlueChest && i == 0)
            {
                try
                {
                    ((XgenBlueChest)block).unifyAdjacentChests(par1TileEntityChest.getWorldObj(), par1TileEntityChest.xCoord, par1TileEntityChest.yCoord, par1TileEntityChest.zCoord);
                }
    ...
    {
        this.renderTileEntityChestAt((BlueXgenChestTileEntity)par1TileEntity, par2, par4, par6, par8);
    }
}
