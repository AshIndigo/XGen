...
public class ItemRedXGenChestRender extends TileEntitySpecialRenderer
{
     ...
     */
    public void renderTileEntityChestAt(RedXgenChestTileEntity par1TileEntityChest, double par2, double par4, double par6, float par8)
    {
        int i;
        ...
        else
        {
            ...
            if (block instanceof XgenRedChest && i == 0)
            {
                try
                {
                    ((XgenRedChest)block).unifyAdjacentChests(par1TileEntityChest.getWorldObj(), par1TileEntityChest.xCoord, par1TileEntityChest.yCoord, par1TileEntityChest.zCoord);
                }
    ...
    {
        this.renderTileEntityChestAt((RedXgenChestTileEntity)par1TileEntity, par2, par4, par6, par8);
    }
}
