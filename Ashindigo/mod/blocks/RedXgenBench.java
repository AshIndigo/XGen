...
public class RedXgenBench extends Block
{
...
public RedXgenBench(int par1)
{
         super(par1, Material.wood);
         //blockIndexInTexture = 59;
         this.setCreativeTab(MainXgenMod.XgenCreativeTab);
}
...
{
player.openGui(MainXgenMod.instance, 1, var1, var2, var3, var4);
return true;
}
else
{
