...
public class XgenRedChest extends BlockContainer
{
    private final Random random = new Random();
    public final int field_94443_a;

    public XgenRedChest(int par1, int par2)
    {
    ...
    public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLiving par5EntityLiving, ItemStack par6ItemStack)
    {
        ...
        {
            ((RedXgenChestTileEntity)par1World.getBlockTileEntity(par2, par3, par4)).func_94043_a(par6ItemStack.getDisplayName());
        }
    }
    ...
    public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, int par5)
    {
        ...
        RedXgenChestTileEntity tileentitychest = (RedXgenChestTileEntity)par1World.getBlockTileEntity(par2, par3, par4);
    ...
    {
        Object object = (RedXgenChestTileEntity)par1World.getBlockTileEntity(par2, par3, par4);
        ...
        else
        {
            if (par1World.getBlockId(par2 - 1, par3, par4) == this.blockID)
            {
                object = new InventoryLargeChest("Red Xgen Large Chest", (RedXgenChestTileEntity)par1World.getBlockTileEntity(par2 - 1, par3, par4), (IInventory)object);
            }

            if (par1World.getBlockId(par2 + 1, par3, par4) == this.blockID)
            {
                object = new InventoryLargeChest("Red Xgen Large Chest", (IInventory)object, (RedXgenChestTileEntity)par1World.getBlockTileEntity(par2 + 1, par3, par4));
            }

            if (par1World.getBlockId(par2, par3, par4 - 1) == this.blockID)
            {
                object = new InventoryLargeChest("Red Xgen Large Chest", (RedXgenChestTileEntity)par1World.getBlockTileEntity(par2, par3, par4 - 1), (IInventory)object);
            }

            if (par1World.getBlockId(par2, par3, par4 + 1) == this.blockID)
            {
                object = new InventoryLargeChest("Red Xgen Large Chest", (IInventory)object, (RedXgenChestTileEntity)par1World.getBlockTileEntity(par2, par3, par4 + 1));
            }
    ...
    {
    	RedXgenChestTileEntity tileentitychest = new RedXgenChestTileEntity();
    ...
    public int isProvidingWeakPower(IBlockAccess par1IBlockAccess, int par2, int par3, int par4, int par5)
    {
        ...
        {
            int i1 = ((RedXgenChestTileEntity)par1IBlockAccess.getBlockTileEntity(par2, par3, par4)).numUsingPlayers;
