...
public class XgenBCore {
	...
	public static void addCore() {
		...
		BlueXgenHelmet = new XGen.Ashindigo.mod.Armor.BlueXgenArmor(3015,BlueXgenArmor,1, 0).setUnlocalizedName("bluexgenhelmet").setCreativeTab(XGen.Ashindigo.mod.MainXgenMod.XgenCreativeTab);
		BlueXgenChestPlate = new XGen.Ashindigo.mod.Armor.BlueXgenArmor(3016, BlueXgenArmor, 1, 1).setUnlocalizedName("bluexgenplate").setCreativeTab(XGen.Ashindigo.mod.MainXgenMod.XgenCreativeTab);
		BlueXgenLegs = new XGen.Ashindigo.mod.Armor.BlueXgenArmor(3017,BlueXgenArmor, 1, 2).setUnlocalizedName("bluexgenlegs").setCreativeTab(XGen.Ashindigo.mod.MainXgenMod.XgenCreativeTab);
		BlueXgenBoots = new XGen.Ashindigo.mod.Armor.BlueXgenArmor(3018,BlueXgenArmor, 1, 3).setUnlocalizedName("bluexgenboots").setCreativeTab(XGen.Ashindigo.mod.MainXgenMod.XgenCreativeTab);
		...
		//LanguageRegistry.addName(BlueXgenChest, "Blue Xgen Chest");
  	   ...
  	   //GameRegistry.addShapelessRecipe(new ItemStack(BlueXgenCrystal,9), new Object[]{BlueXgenBlock });
