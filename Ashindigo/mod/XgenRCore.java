...
import XGen.Ashindigo.mod.items.ItemRedXGenCrystal;
import XGen.Ashindigo.mod.items.RedXgenAxe;
import XGen.Ashindigo.mod.items.RedXgenBow;
import XGen.Ashindigo.mod.items.RedXgenHoe;
import XGen.Ashindigo.mod.items.RedXgenPickaxe;
import XGen.Ashindigo.mod.items.RedXgenSpade;
import XGen.Ashindigo.mod.items.RedXgenSword;
...
public class XgenRCore {
	...
	//GameRegistry.registerBlock(RedXgenChest, XGen.Ashindigo.mod.MainXgenMod.modid + RedXgenChest.getUnlocalizedName());
