...
public class RedXgenChestTileEntity extends TileEntity implements IInventory
{
    ...
    public RedXgenChestTileEntity adjacentChestZNeg;

    /** Contains the chest tile located adjacent to this one (if any) */
    public RedXgenChestTileEntity adjacentChestXPos;

    /** Contains the chest tile located adjacent to this one (if any) */
    public RedXgenChestTileEntity adjacentChestXNeg;

    /** Contains the chest tile located adjacent to this one (if any) */
    public RedXgenChestTileEntity adjacentChestZPosition;
    ...
    {
        return this.isInvNameLocalized() ? this.field_94045_s : "Red Xgen Chest";
    }
    ...
    private void func_90009_a(RedXgenChestTileEntity par1TileEntityChest, int par2)
    {
    ...
    public void checkForAdjacentChests()
    {
        if (!this.adjacentChestChecked)
        {
            ...
            {
                this.adjacentChestXNeg = (RedXgenChestTileEntity)this.worldObj.getBlockTileEntity(this.xCoord - 1, this.yCoord, this.zCoord);
            }

            if (this.func_94044_a(this.xCoord + 1, this.yCoord, this.zCoord))
            {
                this.adjacentChestXPos = (RedXgenChestTileEntity)this.worldObj.getBlockTileEntity(this.xCoord + 1, this.yCoord, this.zCoord);
            }

            if (this.func_94044_a(this.xCoord, this.yCoord, this.zCoord - 1))
            {
                this.adjacentChestZNeg = (RedXgenChestTileEntity)this.worldObj.getBlockTileEntity(this.xCoord, this.yCoord, this.zCoord - 1);
            }

            if (this.func_94044_a(this.xCoord, this.yCoord, this.zCoord + 1))
            {
                this.adjacentChestZPosition = (RedXgenChestTileEntity)this.worldObj.getBlockTileEntity(this.xCoord, this.yCoord, this.zCoord + 1);
            }
