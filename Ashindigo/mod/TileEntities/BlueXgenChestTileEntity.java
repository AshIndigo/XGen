package XGen.Ashindigo.mod.TileEntities;
...
public class BlueXgenChestTileEntity extends TileEntity implements IInventory
{
    ...
    public BlueXgenChestTileEntity adjacentChestZNeg;

    /** Contains the chest tile located adjacent to this one (if any) */
    public BlueXgenChestTileEntity adjacentChestXPos;

    /** Contains the chest tile located adjacent to this one (if any) */
    public BlueXgenChestTileEntity adjacentChestXNeg;

    /** Contains the chest tile located adjacent to this one (if any) */
    public BlueXgenChestTileEntity adjacentChestZPosition;
    ...
    {
        return this.isInvNameLocalized() ? this.field_94045_s : "Blue Xgen Chest";
    }
    ...
    private void func_90009_a(BlueXgenChestTileEntity par1TileEntityChest, int par2)
    {
    ...
    public void checkForAdjacentChests()
    {
        if (!this.adjacentChestChecked)
        {
            ...
            {
                this.adjacentChestXNeg = (BlueXgenChestTileEntity)this.worldObj.getBlockTileEntity(this.xCoord - 1, this.yCoord, this.zCoord);
            }

            if (this.func_94044_a(this.xCoord + 1, this.yCoord, this.zCoord))
            {
                this.adjacentChestXPos = (BlueXgenChestTileEntity)this.worldObj.getBlockTileEntity(this.xCoord + 1, this.yCoord, this.zCoord);
            }

            if (this.func_94044_a(this.xCoord, this.yCoord, this.zCoord - 1))
            {
                this.adjacentChestZNeg = (BlueXgenChestTileEntity)this.worldObj.getBlockTileEntity(this.xCoord, this.yCoord, this.zCoord - 1);
            }

            if (this.func_94044_a(this.xCoord, this.yCoord, this.zCoord + 1))
            {
                this.adjacentChestZPosition = (BlueXgenChestTileEntity)this.worldObj.getBlockTileEntity(this.xCoord, this.yCoord, this.zCoord + 1);
            }
    ...
    private boolean func_94044_a(int par1, int par2, int par3)
    {
        ...
        return block != null && block instanceof XgenRedChest ? ((XgenRedChest)block).field_94443_a == this.func_98041_l() : false;
    }
    ...
    {
        if (this.getBlockType() != null && this.getBlockType() instanceof XgenRedChest)
        {
            --this.numUsingPlayers;
            this.worldObj.addBlockEvent(this.xCoord, this.yCoord, this.zCoord, this.getBlockType().blockID, 1, this.numUsingPlayers);
            this.worldObj.notifyBlocksOfNeighborChange(this.xCoord, this.yCoord, this.zCoord, this.getBlockType().blockID);
    ...
    public int func_98041_l()
    {
        ...
        {
            if (this.worldObj == null || !(this.getBlockType() instanceof XgenRedChest))
            {
                return 0;
            }

            this.field_94046_i = ((XgenRedChest)this.getBlockType()).field_94443_a;
        }
